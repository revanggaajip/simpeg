            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" name="akhir" id="akhir" class="form-control" placeholder="Masukkan Nama ">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="text" name="text" id="text" class="form-control" placeholder="Masukkan Alasan Cuti">
                </div>
            </div>
    </div>
